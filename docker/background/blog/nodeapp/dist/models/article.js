...
exports.getArticles = (current, count = null, type = null, category = null, keyword = null, tag = null, deviceAgent = null) => __awaiter(this, void 0, void 0, function* () {
    ...
    let rows = null;
    try {
        rows = (yield db_1.default.query(sql));
    }
    catch (error) {
        throw error;
    }
    ...
    if (current != null) {
        try {
            const totalRows = yield db_1.default.query(totalSql);
...
exports.getArticleDetail = (id) => __awaiter(this, void 0, void 0, function* () {
