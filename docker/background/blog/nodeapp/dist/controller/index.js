...
const getArt = (ctx) => __awaiter(this, void 0, void 0, function* () {
    const articleData = yield articleModel.getArticles(1, 15, null, null, null, null, ctx.req.headers['user-agent'].toLowerCase());
